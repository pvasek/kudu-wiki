...
For Free and Shared site, there is a 200MB limit (note: double check this!) for all these locations together (i.e. not per-folder). For Standard site, the limit is very high.
